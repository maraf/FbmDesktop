...
Tym::Tym(String NazevTymu, String NazevTymuKr, String NazevHaly, String Logo, int KapacitaHaly, int PocetHracu, int PocetLajn, int DobaStridani, int Sponzor){
//                bVlastnictvi = false;
...
//void Tym::setVlastnictvi(bool Vl){
//                bVlastnictvi = Vl;
//}
//---------------------------------------------------------------------------------------------
