...
//              bool bVlastnictvi;
      ...
      public:
              ...
              Tym();
              Tym(String NazevTymu, String NazevTymuKr, String NazevHaly, String cLogo, int KapacitaHaly, int PocetHracu, int PocetLajn, int DobaStridani, int Sponzor);
              ~Tym();

//              void setVlastnictvi(bool Vl);
