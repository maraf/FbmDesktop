...
void Zapas::regenerace(int iLajn, int j, int Kolik){
                        for(int i = (iLajn - 1) * 5 + 1; i < (iLajn - 1) * 5 + 1 + 5; i ++){
                                if(Tymy[j]->Hraci[i]->getEnergie() != 100)
...
//                for(int j = 0; j < 2; j ++){
//                        for(int i = (iLine[j] - 1) * 5 + 1; i < (iLine[j] - 1) * 5 + 1 + 5; i ++){
//                                Tymy[j]->Hraci[i]->setEnergie(Tymy[j]->Hraci[i]->getEnergie() - 2);
//                        }
//                }
                        for(int i = (iLajn - 1) * 5 + 1; i < (iLajn - 1) * 5 + 1 + 5; i ++){
                                if(Tymy[j]->Hraci[i]->getEnergie() > 1)
                                        Tymy[j]->Hraci[i]->setEnergie(Tymy[j]->Hraci[i]->getEnergie() - Kolik);
                        }
}
//---------------------------------------------------------------------------------------------
