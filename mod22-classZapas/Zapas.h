...
class Zapas{
      ...
      private:
              ...
              void regenerace(int iLajn, int j, float Kolik); // zvysuje energie, int Kolik je o kolik
              void unava(int iLajn, int j, float Kolik); // snizuje energii, int j je Tym
