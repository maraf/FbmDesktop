...
class Lajna{
      ...
      public:
              Lajna();
              Lajna(int iGm, int iRG, int iLd, int iRd, int iLw, int iRw, int iCe, bool bEn, bool bVa);
              ~Lajna();
              
              void setAllPosts(int iGm, int iRG, int iLd, int iRd, int iLw, int iRw, int iCe);
              void setGoalman(int iGm);
              void setGoalman(char *cGm);
              void setReserveGoalman(int iGm);
              void setReserveGoalman(char *cGm);
