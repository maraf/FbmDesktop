                ...
                while((cZnak = getc(fTeam)) != EOF){
                             ...
                             if(cZnak == '-'){
                                      ...
                                      switch(iLine){
                                                     ...
                                                     case 2: cNazevHaly = cPole; break;
                                                     case 3: iKapacitaHaly = atoi(cPole); break;
                                                     case 4: iR1 = atoi(cPole); break;
                                                     case 5: iG1 = atoi(cPole); break;
                                                     case 6: iB1 = atoi(cPole); break;
                                                     case 7: iR2 = atoi(cPole); break;
                                                     case 8: iG2 = atoi(cPole); break;
                                                     case 9: iB2 = atoi(cPole); break;
                ...
                while((cZnak = getc(fTeam)) != EOF){
                             ...
                             if(cZnak == '-'){
                                      ...
                                      switch(iIndex){
                                                     ...
                                                     case 8: Hraci[iHrac]->setVek(cPole); break;
                                                     case 9: Hraci[iHrac]->setSmlouva(2100); break;
                                      }
                                      iIndex ++;
                             }
                             if(cZnak == '\n'){
...
void Tym::Hraci_sort_celkove(bool bVzestupne){
    ...
    while(j < iPocetHracu){
            while(i < iPocetHracu){
                    ...
                    if(iCelkem1 == iCelkem2 && Hraci[j]->getPost() == Hraci[i]->getPost() && Hraci[j]->getCislo() < Hraci[i]->getCislo()){
