...
class Tym{
      ...
      private:
              ...
              void Hraci_sort_golyL(bool bVzestupne);
              void Hraci_sort_asistenceL(bool bVzestupne);
              void Hraci_sort_kanBodyL(bool bVzestupne);
              void Hraci_sort_energie(bool bVzestupne);
      ...
      public:
              ...
              void setTrainingIntensity(float TrIn);
              void trainingTeam();
              ...
              void deletePlayerAt(int i);
              void addPlayer(Hrac *Player);
              bool isFreeNumber(int number);
              int getCountOfGoalkeepers();
              int getCountOfDefenders();
              int getCountOfAttackers();
              int getTraining();
              float getTrainingIntensity();
              void setRGB1(TColor rgb);
              void setRGB2(TColor rgb);
              void setRGB(TColor rgb1, TColor rgb2);
              TColor getRGB1();
              TColor getRGB2();
              //void setTeamLogo(TPicture *logo);
              //void setTeamHall(TPicture *hall);
              //TPicture getTeamLogo();
              //TPicture getTeamHall();
              ...
              void setDaneSL(int DaneSL);
              void setObdrzeneSL(int ObdrzeneSL);
