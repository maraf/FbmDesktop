...
Hrac::Hrac(int id, char Post, int Cislo, String Jmeno, String Prijmeni, int Vek, int FS, int TS, int ZS, int Smlouva, int TypSmlouvy, int Plat){
                cPost = Post;
                iCislo = Cislo;
                cJmeno = Jmeno;
                cPrijmeni = Prijmeni;
...
void Hrac::setTypSmlouvy(int TypSmlouvy) {
                iTypSmlouvy = TypSmlouvy;
}
//---------------------------------------------------------------------------------------------

void Hrac::setTypSmlouvy(char *TypSmlouvy) {
                int iPomTypSmlouvy = atoi(TypSmlouvy);
                iTypSmlouvy = iPomTypSmlouvy;
}
//---------------------------------------------------------------------------------------------

void Hrac::setPlat(int Plat) {
                iPlat = Plat;
}
//---------------------------------------------------------------------------------------------

void Hrac::setPlat(char *Plat) {
                int iPomPlat = atoi(Plat);
                iPlat = iPomPlat;
}
//---------------------------------------------------------------------------------------------
