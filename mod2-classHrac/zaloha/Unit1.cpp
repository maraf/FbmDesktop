...
//        delete(Muj);
        ...
        while((cZnak = getc(fTeam)) != EOF){
                ...
                if(cZnak == '-'){
                        ...
                        switch(iIndex){
                               ...
                               case 5: Hraci[iHrac]->setFS(cRychlost); break;
                               case 6: Hraci[iHrac]->setTS(cTechnika); break;
        ...
        while(iHrac < 11){
                fprintf(fTeam, "%c-%s-%s-%i-%i-%i-%i", Hraci[iHrac]->getPost(), Hraci[iHrac]->getJmeno(), Hraci[iHrac]->getPrijmeni(), Hraci[iHrac]->getVek(), Hraci[iHrac]->getFS(), Hraci[iHrac]->getTS(), Hraci[iHrac]->getSmlouva());
