...
void Tym::playersSalary() {
     float salary = 0;
     
     for(int i = 0; i < getPocetHracu(); i ++) {
          salary += Hraci[i]->getSalary();
     }
     
     Economy->outCome(salary, ECO_PL_SALARY);
}
//--------------------------------------------------------------------------------------------

void Tym::setRGB1(TColor rgb) {
    RGB_1 = rgb;
}
//---------------------------------------------------------------------------------------------

void Tym::setRGB2(TColor rgb) {
    RGB_2 = rgb;
}
//---------------------------------------------------------------------------------------------

void Tym::setRGB(TColor rgb1, TColor rgb2) {
    RGB_1 = rgb1;
    RGB_2 = rgb2;
}
//---------------------------------------------------------------------------------------------
...
//void Tym::setTeamLogo(TPicture *logo) {
//    LogoImage = logo;
//}
//---------------------------------------------------------------------------------------------

//void Tym::setTeamHall(TPicture *hall) {
//    HallImage = hall;
//}
//---------------------------------------------------------------------------------------------

//TPicture Tym::getTeamLogo() {
//    return *LogoImage;
//}
//---------------------------------------------------------------------------------------------

//TPicture Tym::getTeamHall() {
//    return *HallImage;
//}
//---------------------------------------------------------------------------------------------
